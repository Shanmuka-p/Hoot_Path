// ─── lsrw_api_service.dart ────────────────────────────────────────────────────
// This is the correctly-named version of the file (previously lsrw_api_service.dart.dart).
// The old file (lsrw_api_service.dart.dart) can be deleted safely — all imports
...
String _resolveIconUrl(String? raw) {
  ...
  return '$kLsrwApiBaseHost${raw.startsWith('/') ? raw : '/$raw'}';
}
