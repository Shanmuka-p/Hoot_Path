// ─── lib/views/day_task_view.dart ─────────────────────────────────────────────
//  View layer — pure UI for the Day Task detail screen.
//  Calls LearningPathService directly (simple fire-and-forget action).
//  Import updated to use services/ path.
// ─────────────────────────────────────────────────────────────────────────────
                        ...
                        child: Column(
                          ...
                          children: [
                                      ...
                                      Row(
                                        children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(color: skillColor.withOpacity(0.12), borderRadius: BorderRadius.circular(6)),
                                            child: Text(skill, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: skillColor)),
                                          ),
                                          const SizedBox(width: 6),
                                          Container(
                                            padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                            decoration: BoxDecoration(color: complexityColor.withOpacity(0.12), borderRadius: BorderRadius.circular(6)),
                                            child: Text(_getComplexityLabel(complexity), style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: complexityColor)),
                                          ),
                                          const SizedBox(width: 6),
                                          Text(
                                            'x${task['count']}',
                            ...
                            if (courseName.isNotEmpty) ...[
                              const SizedBox(height: 8),
                              Text(courseName, style: TextStyle(fontSize: 11, color: Colors.grey.shade500), overflow: TextOverflow.ellipsis, maxLines: 1),
                            ],
                          ],
                        ),
                      );
