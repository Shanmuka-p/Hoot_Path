// ─── lib/views/skill_detail_sheet.dart ────────────────────────────────────────
//  View layer — bottom sheet UI for individual LSRW skill detail.
//  Import updated to use MVC-organized lib/models/lsrw_models.dart.
//  No business logic changed — purely a re-path.
// ─────────────────────────────────────────────────────────────────────────────
                                ...
                                child: Align(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const Text('Overall', style: TextStyle(fontSize: 12, color: kTextGrey)),
                                    ],
                                  ),
                                ),
                              ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(_tipFor(pct), style: const TextStyle(fontSize: 13, color: kTextGrey, height: 1.5)),
                              ],
                            ),
                          ),
                        ],
...
class _ModuleCard extends StatelessWidget {
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(color: complexityColor.withOpacity(0.12), borderRadius: BorderRadius.circular(6)),
                          child: Text(complexityLabel, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: complexityColor)),
                        ),
                        const SizedBox(width: 6),
                        Text('${record.count} attempts', style: const TextStyle(fontSize: 11, color: kTextGrey)),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _initialAvatar() {
    final initial = record.moduleName.isNotEmpty ? record.moduleName[0].toUpperCase() : '?';
    return Container(
      width: 36, height: 36,
      decoration: BoxDecoration(color: skillColor.withOpacity(0.12), borderRadius: BorderRadius.circular(8)),
      child: Center(
        child: Text(initial, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: skillColor)),
      ),
    );
  }
}
